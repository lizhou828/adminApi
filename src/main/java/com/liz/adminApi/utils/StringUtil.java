...
public class StringUtil {
    ...
    public static String createOrderSn(){
        ...
        buffer.append("SN");
        buffer.append(date);
        buffer.append(IntUtils.getRandomIntStrByLength(8));
     ...
     * @return
     */
    public static String createPayFlowSn(){
        String date = new SimpleDateFormat("yyyyMMDDHHmmssSSS").format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append("PF");
        buffer.append(date);
     ...
     * @return
     */
    public static String createRefundSn(){
        String date = new SimpleDateFormat("yyyyMMDDHHmmssSSS").format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append("RN");
        buffer.append(date);
     ...
     * @return
     */
    public static String createSettleSn(){
        String date = new SimpleDateFormat("yyyyMMDDHHmmssSSS").format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append("ST");
        buffer.append(date);
    ...
    public static String createGoodsSpuCode(){
        String date = new SimpleDateFormat("yyyyMMDDHHmmssSSS").format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append("SP");
        buffer.append(date);
    ...
    public static String createGoodsSkuCode(){
        String date = new SimpleDateFormat("yyyyMMDDHHmmssSSS").format(new Date());
        StringBuffer buffer = new StringBuffer();
        buffer.append("SK");
        buffer.append(date);
    ...
    public static boolean isEmpty(String str){
        return org.springframework.util.StringUtils.isEmpty(str) || "null".equalsIgnoreCase(str);
    }
     ...
     * @return
     */
    public static String formatID(String idStr){
        if(isEmpty(idStr)){
            return "";
        }
        if(idStr.contains("\"")){
