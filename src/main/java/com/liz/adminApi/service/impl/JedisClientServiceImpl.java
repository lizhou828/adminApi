...
public class JedisClientServiceImpl implements JedisClientIService {
    ...
    private static final Logger logger = LogManager.getLogger(JedisClientServiceImpl.class);
    ...
    public boolean hSet(String key, String field, String value) {
        try{
            ...
            logger.error("redisTemplate.opsForHash().put("+key+","+field+" ,"+value+") failed:" + e.getMessage(),e);
            return false;
        }
    }
    ...
    public boolean hDel(String key, String... fields) {
        Long resultCount =  redisTemplate.opsForHash().delete(key,fields);
    ...
    public void setStringValue(String key, String str, long timeOut, TimeUnit unit) {
        try {
            ...
            logger.error("set error:" + ex.getMessage(), ex);
        }
    }
